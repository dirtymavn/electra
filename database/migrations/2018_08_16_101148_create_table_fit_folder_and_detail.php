...
class CreateTableFitFolderAndDetail extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('trx_fit_folder', function (Blueprint $table) {
            $table->increments('id');
            $table->string('fit_code')->nullable();
            $table->string('fit_name')->nullable();
        ...
        Schema::create('trx_fit_folder_detail', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('id_fit_folder')->unsigned()->nullable();
            ...
            $table->integer('branch_id')->unsigned()->nullable();
            $table->timestamps();
            $table->foreign('id_fit_folder')->references('id')->on('trx_fit_folder')->onDelete('cascade');
        });

        Schema::create('trx_fit_folder_itinerary', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('id_fit_folder')->unsigned()->nullable();
        ...
        Schema::create('trx_fit_folder_service', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('id_fit_folder')->unsigned()->nullable();
        ...
        Schema::create('trx_fit_folder_rate', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('id_fit_folder')->unsigned()->nullable();
        ...
        Schema::create('trx_fit_folder_guide', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('id_fit_folder')->unsigned()->nullable();
