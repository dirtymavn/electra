...
use App\DataTables\Fit\FitDeliveryDataTable;

use App\Models\Fit\Delivery\TrxFitDeliveryOrder as TrxDelivery;
...
class FitDeliveryController extends Controller
{
    /**
     ...
     */
    public function index(FitDeliveryDataTable $dataTable)
    {
        return $dataTable->render('contents.fits.delivery.index');
    }
    ...
    public function create()
    {
        ...
        return view('contents.fits.delivery.create', compact('dotypes', 'newCode', 'customers', 'departmens'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($insert) {
                $redirect = redirect()->route('fit-delivery.index');
                if (@$request->is_draft == 'true') {
                    $redirect = redirect()->route('fit-delivery.edit', $insert->id)->withInput();
                } elseif (@$request->is_publish_continue == 'true') {
                    $redirect = redirect()->route('fit-delivery.create');
                }
    ...
    public function edit($id)
    {
        ...
        $customers = MasterCustomer::getAvaliable()->pluck('customer_name', 'id')->all();
        $departmens = Department::getAvailableData()->pluck('department_name', 'company_departments.id')->all();
        return view('contents.fits.delivery.edit', compact('delivery', 'dotypes', 'newCode', 'customers', 'departmens'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('fit-delivery.index');
    }
    ...
    public function export_pdf()
    {
        ...
        $pdf = PDF::loadView('contents.fits.delivery.pdf', compact('deliveries'));
