...
use App\DataTables\Outbound\DeliveryDataTable;
...
class DeliveryController extends Controller
{
    ...
    {
        return $dataTable->render('contents.outbounds.delivery.index');
    }
    ...
    public function create()
    {
        ...
        return view('contents.outbounds.delivery.create', compact('dotypes', 'newCode', 'customers', 'departmens'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($insert) {
                $redirect = redirect()->route('outbound-delivery.index');
                if (@$request->is_draft == 'true') {
                    $redirect = redirect()->route('outbound-delivery.edit', $insert->id)->withInput();
                } elseif (@$request->is_publish_continue == 'true') {
                    $redirect = redirect()->route('outbound-delivery.create');
                }
    ...
    public function edit($id)
    {
        ...
        $customers = MasterCustomer::getAvaliable()->pluck('customer_name', 'id')->all();
        $departmens = Department::getAvailableData()->pluck('department_name', 'company_departments.id')->all();
        return view('contents.outbounds.delivery.edit', compact('delivery', 'dotypes', 'newCode', 'customers', 'departmens'));
    }
    ...
    public function export_pdf()
    {
        ...
        $pdf = PDF::loadView('contents.outbounds.delivery.pdf', compact('deliveries'));
