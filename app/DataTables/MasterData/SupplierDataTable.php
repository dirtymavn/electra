    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('action', function($supplier){
                ...
                if (user_info()->hasAccess('admin.company') || (user_info()->hasAccess('supplier.update') && user_info()->hasAccess('supplier.destroy')) ) {
                    return view('partials.action-button')->with(compact('edit_url', 'delete_url'));
                } elseif (user_info()->hasAnyAccess(['admin.company', 'supplier.update'])) {
                    return view('partials.action-button')->with(compact('edit_url'));    
                } elseif (user_info()->hasAnyAccess(['admin.company', 'supplier.destroy'])) {
