...
class FitOrder extends Model implements Auditable
{
     ...
     * @var string
     */
    protected $table = 'trx_fit_orders';
    ...
    protected static function boot()
    {
        ...
        self::created(function($tourOrder) {
            ...
            if ($tour) {
            	$tourOrderTour = new FitOrderTour;
	            $tourOrderTour->master_tour_id = $tour->id;
		        $tourOrderTour->trx_fit_order_id = $tourOrder->id;
            ...
            if (count($tourPaxlists) > 0) {
                foreach ($tourPaxlists as $tourPaxlist) {
                    ...
                    $paxlist->trx_fit_order_id = $tourOrder->id;
    ...
    {
    	return $this->hasOne(FitOrderTour::class, 'trx_fit_order_id');
    }

    public function paxLists()
    {
    	return $this->hasMany(FitOrderPaxList::class, 'trx_fit_order_id');
    }
