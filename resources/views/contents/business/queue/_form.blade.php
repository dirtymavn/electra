...
{!! JsValidator::formRequest('App\Http\Requests\MasterData\DocumentRequest', '#form-businessqueue') !!}
<script>
    $(function(){
    ...
    $(document).ready(function() {
        ...
        initDatatable($('#data-document'), "{{route('businessqueue.get-data')}}", columns, datas);
        ...
        $('#form-data-document').submit(function(e) {
            ...
            $.ajax({
                url: "{{route('businessqueue.rate.post')}}",
                method: "POST",
                processData: false,
                contentType: false,
                dataType: "JSON",
    ...
    $(document).on('click', '.deleteData', function() {
        var id = $(this).data('id');
        $.ajax({
            url: "{{route('businessqueue.data.delete')}}",
            method: "POST",
            dataType: "JSON",
            data: {'id':id},
            success: function(data) {
    ...
    $(document).on('click', '.editData', function() {
        ...
        var id = $(this).data('id');
        $.ajax({
            url: "{{route('businessqueue.data.detail')}}",
            method: "POST",
            dataType: "JSON",
            data: {'id':id},
            success: function(data) {
