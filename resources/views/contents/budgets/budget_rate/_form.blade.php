<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text('acc_period_mo', old('acc_period_mo') , ['class' => 'form-control', 'placeholder' => 'Input the Fiscal Year']) !!}
        </div>
        <div class="form-group">
...
{!! JsValidator::formRequest('App\Http\Requests\Budget\BudgetRateRequest', '#form-budgetrate') !!}
<script>
    $(function(){
