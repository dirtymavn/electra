...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route('accounting.invoice.index')}}">Accounting</a></li>
...
<div class="row">
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'accounting.invoice.create']))
            <a href="{{ route('accounting.invoice.create')}}" class="btn btn-primary" id="btn-submit">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'accounting.invoice.destroy']))
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('accounting.invoice.export.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('accounting.invoice.export.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).on('click', '#bulk-delete', function() {
        ...
        if (ids.length > 0) {
            bulkDelete("{{ route('accounting.invoice.bulk-delete') }}", ids);
        } else {
