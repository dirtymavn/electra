                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('description', old('description') , ['class' => 'form-control','rows'=>4, 'placeholder' => 'Input the Product code']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('coa_id', trans('Cost Account'), ['class' => 'control-label']) !!}
                            {!! Form::select('coa_id',[''=>'Choose Customer']+ @$listCoa, old('coa_id'), [ 'class' => 'form-control','required'=>true]) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('unit_cost', trans('Unit Cost'), ['class' => 'control-label']) !!}
                            {!! Form::text('unit_cost', old('unit_cost') , ['class' => 'form-control', 'placeholder' => 'Input the Product code']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('cost_gst', trans('Cost GST'), ['class' => 'control-label']) !!}
                            {!! Form::text('cost_gst', old('cost_gst') , ['class' => 'form-control', 'placeholder' => 'Input the Product code']) !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('sales_id', trans('Sales A/C'), ['class' => 'control-label']) !!}
                            {!! Form::select('sales_id',[''=>'Choose Customer']+ @$listSales, old('sales_id'), [ 'class' => 'form-control','required'=>true]) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('unit_price', trans('Unit Price'), ['class' => 'control-label']) !!}
                            {!! Form::text('unit_price', old('unit_price') , ['class' => 'form-control', 'placeholder' => 'Input the Product code']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('qty', trans('QTY'), ['class' => 'control-label']) !!}
                            {!! Form::number('qty', old('qty') , ['class' => 'form-control', 'placeholder' => 'Input the Product code']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('gst', trans('GST'), ['class' => 'control-label']) !!}
                            {!! Form::text('gst', old('gst') , ['class' => 'form-control', 'placeholder' => 'Input the Product code']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('total_sales', trans('Total Sales'), ['class' => 'control-label']) !!}
                            {!! Form::number('total_sales', old('total_sales') , ['class' => 'form-control', 'placeholder' => 'Input the Product code']) !!}
                        </div>
                    </div>
                </div>
            </div>
