...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route('accounting.misc-invoice.index')}}">Accounting</a></li>
    <li class="breadcrumb-item">Invoice</li>
</ul>
@endsection

@section('page_title', 'Invoice Lists')

@section('content')
@include('flash::message')
<div class="row">
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'accounting.misc-invoice.create']))
            <a href="{{ route('accounting.misc-invoice.create')}}" class="btn btn-primary" id="btn-submit">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'accounting.misc-invoice.destroy']))
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('accounting.misc-invoice.export.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('accounting.misc-invoice.export.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        spinnerLoad($('#form-master-invoice'));
    });
    ...
    $(document).on('click', '#bulk-delete', function() {
        ...
        if (ids.length > 0) {
            bulkDelete("{{ route('accounting.misc-invoice.bulk-delete') }}", ids);
        } else {
