...
@section('title', 'Create Core Status')
...
@section('page_title', 'Create Core Status')

@section('content')
    @include('flash::message')
    {!! Form::open([
            'route' =>  'core-status.store',
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a href="{{route('core-status.index')}}" class="btn btn-grey">Cancel</a>
...
@section('script')
<script>
    submitForm("{{route('core-status.store')}}", $('#form-status'), 'create');
</script>
@endsection