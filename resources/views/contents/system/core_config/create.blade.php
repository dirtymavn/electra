...
@section('title', 'Create Core Config')
...
@section('page_title', 'Create Core Config')

@section('content')
    @include('flash::message')
    {!! Form::open([
            'route' =>  'core-config.store',
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a href="{{route('core-config.index')}}" class="btn btn-grey">Cancel</a>
...
@section('script')
<script>
    submitForm("{{route('core-config.store')}}", $('#form-core-config'), 'create');
</script>
@endsection