...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Hotel Booking</li>
</ul>
@endsection

@section('page_title', 'Hotel Booking Lists')
...
<div class="row">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'hotel-booking.destroy']))
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('export.hotel-booking.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('export.hotel-booking.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
