...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Fitfolder</li>
</ul>
@endsection

@section('page_title', 'Fit folder Lists')

@section('content')
@include('flash::message')
<div class="row">
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'fitfolder.create']))
            <a href="{{ route('fitfolder.create')}}" class="btn btn-primary" id="btn-submit">
                <i class="fa fa-plus m-right-10"></i> Add Fit folder
            </a>
        @endif
    </div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'fitfolder.destroy']))
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('export.fitfolder.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('export.fitfolder.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        spinnerLoad($('#form-master-fitfolder'));
    });
    ...
    $(document).on('click', '#bulk-delete', function() {
        ...
        if (ids.length > 0) {
            bulkDelete("{{ route('fitfolder.bulk-delete') }}", ids);
        } else {
