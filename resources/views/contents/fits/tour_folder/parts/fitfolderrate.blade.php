        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <button type="button" class="btn btn-primary form-control btn-add-fitfolderrate col-md-2"><i class="fa fa-plus m-right-10"></i> Add</button>
                </div>
                <div class="form-group">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="fitfolderrate-detail" style="width:100%;">
                            <thead>
...
@push('models')
<div id="form-fitfolderrate" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {!! Form::open(['id' => 'form-fitfolderrate-detail', 'method' => 'post']) !!}
            <input type="hidden" value="" name="fitfolderrate_id" id="fitfolderrate_id">
                        
            <div class="modal-header">
                <h4 class="modal-title">Fit folder rate</h4>
            ...
            <div class="modal-footer">
                ...
                <button id="form-fitfolderrate-accept" type="button" class="btn btn-success pull-left">    <i class="fa fa-check"></i> Submit
                </button>
            </div>
            {!! Form::close() !!}
        </div>
