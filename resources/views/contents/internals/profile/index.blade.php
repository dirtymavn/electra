...
@section('page_title', 'Profile Lists')

@section('content')
@include('flash::message')
<a href="{{ route('profile.create')}}" class="btn btn-primary" id="btn-submit">
    <i class="fa fa-plus m-right-10"></i> Add Profile
</a>
...
<script>
    ...
    $(document).on('click', '#bulk-delete', function() {
        ...
        if (ids.length > 0) {
            bulkDelete("{{ route('profile.bulk-delete') }}", ids);
        } else {
