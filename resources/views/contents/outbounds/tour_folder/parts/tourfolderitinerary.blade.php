        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <button type="button" class="btn btn-primary form-control btn-add-tourfolderitinerary col-md-2"><i class="fa fa-plus m-right-10"></i> Add</button>
                </div>
                <div class="form-group">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="tourfolderitinerary-detail" style="width:100%;">
                            <thead>
...
@push('models')
<div id="form-tourfolderitinerary" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {!! Form::open(['id' => 'form-tourfolderitinerary-detail', 'method' => 'post']) !!}
            <input type="hidden" value="" name="tourfolderitinerary_id" id="tourfolderitinerary_id">
            ...
            <div class="modal-footer">
                ...
                <button id="form-tourfolderitinerary-accept" type="button" class="btn btn-success pull-left">    <i class="fa fa-check"></i> Submit
                </button>
            </div>
            {!! Form::close() !!}
        </div>
