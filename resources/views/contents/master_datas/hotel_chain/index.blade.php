...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Hotel Chain</li>
</ul>
@endsection

@section('page_title', 'Hotel Chain Lists')

@section('content')
@include('flash::message')
<div class="row">
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'hotel-chain.create']))
            <a href="{{ route('hotel-chain.create')}}" class="btn btn-primary" id="btn-submit">
                <i class="fa fa-plus m-right-10"></i> Add Hotel Chain Lists
            </a>
        @endif
    </div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'hotel-chain.destroy']))
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('export.hotel-chain.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('export.hotel-chain.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).on('click', '#bulk-delete', function() {
        ...
        if (ids.length > 0) {
            bulkDelete("{{ route('hotel-chain.bulk-delete') }}", ids);
        } else {
