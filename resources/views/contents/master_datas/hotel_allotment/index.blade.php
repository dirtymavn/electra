...
@section('title', 'Master Hotel Allotment')
...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Master Hotel Allotment</li>
</ul>
@endsection
...
<div class="row">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'hotel-allotment.destroy']))
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('export.hotel-allotment.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('export.hotel-allotment.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        spinnerLoad($('#form-master-hotel-allotment'));
    });
    ...
    $(document).on('click', '#bulk-delete', function() {
        ...
        if (ids.length > 0) {
            bulkDelete("{{ route('hotel-allotment.bulk-delete') }}", ids);
        } else {
