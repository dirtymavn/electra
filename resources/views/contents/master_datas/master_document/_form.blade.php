...
{!! JsValidator::formRequest('App\Http\Requests\MasterData\DocumentRequest', '#form-document') !!}
<script>
    $(function(){
    ...
    $(document).ready(function() {
        ...
        initDatatable($('#data-document'), "{{route('document.get-data')}}", columns, datas);
    ...
    $(document).on('click', '.deleteData', function() {
        var id = $(this).data('id');
        $.ajax({
            url: "{{route('document.data.delete')}}",
            method: "POST",
            dataType: "JSON",
            data: {'id':id},
            success: function(data) {
    ...
    $(document).on('click', '.editData', function() {
        ...
        var id = $(this).data('id');
        $.ajax({
            url: "{{route('document.data.detail')}}",
            method: "POST",
            dataType: "JSON",
            data: {'id':id},
            success: function(data) {
