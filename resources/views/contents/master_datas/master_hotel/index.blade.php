...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Master Hotel</li>
</ul>
@endsection

@section('page_title', 'Master Hotel Lists')

@section('content')
@include('flash::message')
<div class="row">
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'master-hotel.create']))
            <a href="{{ route('master-hotel.create')}}" class="btn btn-primary" id="btn-submit">
                <i class="fa fa-plus m-right-10"></i> Add Master Hotel Lists
            </a>
        @endif
    </div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'master-hotel.destroy']))
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('export.master-hotel.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('export.master-hotel.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).on('click', '#bulk-delete', function() {
        ...
        if (ids.length > 0) {
            bulkDelete("{{ route('master-hotel.bulk-delete') }}", ids);
        } else {
