...
<div class="row">
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'budget-rate.create']))
    ...
    &nbsp;&nbsp;&nbsp;
    <div class="col-sm-2">
        @if(user_info()->hasAnyAccess(['admin.company', 'budget-rate.destroy']))
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('export.budget-rate.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('export.budget-rate.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
