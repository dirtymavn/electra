...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Account (COA)</li>
</ul>
@endsection

@section('page_title', 'Account (COA) Lists')
    ...
    <div class="col-sm-3">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('export.account.excel') }}">Export XLS</a>
                <a class="dropdown-item" href="{{ route('export.account.pdf') }}">Export PDF</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).on('click', '#bulk-delete', function() {
        ...
        if (ids.length > 0) {
            bulkDelete("{{ route('account.bulk-delete') }}", ids);
        } else {
