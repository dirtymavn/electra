...
@section('title', 'Create Currency Rate')
...
@section('page_title', 'Create Currency Rate')

@section('content')
    @include('flash::message')
    {!! Form::open([
            'route' =>  'currencyrate.store',
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a href="{{route('currencyrate.index')}}" class="btn btn-grey">Cancel</a>
...
@section('script')
<script>
    submitForm("{{route('currencyrate.store')}}", $('#form-currencyrate'), 'create');
</script>
@endsection