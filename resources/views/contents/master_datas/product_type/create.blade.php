...
@section('page_title', 'Create Product Type')
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a href="{{route('product-type.index')}}" class="btn btn-grey">Cancel</a>
...
@section('script')
<script>
    submitForm("{{route('product-type.store')}}", $('#form-producttype'), 'create');
</script>
@endsection