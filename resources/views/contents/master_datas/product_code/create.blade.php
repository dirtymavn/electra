...
@section('page_title', 'Create Product Code')

@section('content')
    @include('flash::message')
    {!! Form::open([
            'route' =>  'productcode.store',
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a href="{{route('productcode.index')}}" class="btn btn-grey">Cancel</a>
...
@section('script')
<script>
    submitForm("{{route('productcode.store')}}", $('#form-productcode'), 'create');
</script>
@endsection