...
@section('title', 'Create Accounting Config')
...
@section('page_title', 'Create Accounting Config')

@section('content')
    @include('flash::message')
    {!! Form::open([
            'route' =>  'accounting-config.store',
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a href="{{route('accounting-config.index')}}" class="btn btn-grey">Cancel</a>
...
@section('script')
<script>
    // submitForm("{{route('accounting-config.store')}}", $('#form-accountingconfig'), 'create');
</script>
@endsection