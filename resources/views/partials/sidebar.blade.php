            ...
            <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                    ...
                    <ul class="sub-menu"> -->
                        ...
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Queue</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Report</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                    <ul class="sub-menu">
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Tour Folder</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Tour Order</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Visa</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Availability</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li class="sub-submenu">
                            <a>
                                <i class="os-icon os-icon-user"></i><span>Report</span><i class="arrow-third-menu os-icon os-icon-chevron-down"></i>
                            </a>
                            <div class="sub-menu-w third-menu">
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Visa Report</span>
                                            </a>
                                        </li>
                                    <ul>
                                </div>
            ...
            <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                    <ul class="sub-menu">
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Enquiry</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Booking</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
            ...
            <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                    <ul class="sub-menu">
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>FIT Folder</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Delivery</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
            ...
            <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                    <ul class="sub-menu">
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Invoice</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Misc Invoice</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Credit Note</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Billing</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>LG Delivery</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Pay Request</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Petty Cash</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li class="sub-submenu">
                            <a>
                                <i class="os-icon os-icon-user"></i><span>Settlement</span><i class="arrow-third-menu os-icon os-icon-chevron-down"></i>
                            </a>
                            <div class="sub-menu-w third-menu">
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Deposit</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Settlement</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Receipt</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Receipt Voucher</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Payment</span>
                                            </a>
                                        </li>
                                    <ul>
                                </div>
                        ...
                        <li class="sub-submenu">
                            <a>
                                <i class="os-icon os-icon-user"></i><span>General Ledger</span><i class="arrow-third-menu os-icon os-icon-chevron-down"></i>
                            </a>
                            <div class="sub-menu-w third-menu">
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Journal</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Posting</span>
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Reconciliation</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Bank Reconciliation</span>
                                            </a>
                                        </li><li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>BSP Reconciliation</span>
                                            </a>
                                        </li>
                                    <ul>
                                </div>
                        ...
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Refund</span>
                            </a>
                        </li>
                            ...
                            <div class="sub-menu-w third-menu">
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Receipt Enquiry</span>
                                            </a>
                                        </li>
                                    <ul>
                                </div>
            ...
            <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>L/G</span>
                            </a>
                        </li><li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Financial Analysis</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Cheque Printing</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Bank Deposit</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li class="sub-submenu">
                            <a>
                                <i class="os-icon os-icon-user"></i><span>Outbond</span><i class="arrow-third-menu os-icon os-icon-chevron-down"></i>
                            </a>
                            <div class="sub-menu-w third-menu">
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Air Allotment</span>
                                            </a>
                                        </li>
                                    <ul>
                                </div>
                        ...
                        <li class="sub-submenu">
                            <a>
                                <i class="os-icon os-icon-user"></i><span>Accounting Setup</span><i class="arrow-third-menu os-icon os-icon-chevron-down"></i>
                            </a>
                            <div class="sub-menu-w third-menu">
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>FX Transaction</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Budget Rate</span>
                                            </a>
                                        </li><li>
                                            <a href="#">
                                                <i class="os-icon os-icon-user"></i><span>Account</span>
                                            </a>
                                        </li>
                                    <ul>
                                </div>
                        ...
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Credit Card</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="sub-menu-w">
                ...
                <div class="sub-menu-i">
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Users</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Role</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>Permission</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="os-icon os-icon-user"></i><span>System Config</span>
                            </a>
                        </li>
                    </ul>
                </div>
