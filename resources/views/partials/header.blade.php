    ...
    <div class="top-menu-controls">
        ...
        <div class="logged-user-w">
            <div class="logged-user-i">
                ...
                <span class="ml10"><strong>{{ user_info('full_name') }}</strong></span>
                <div class="logged-user-menu color-style-bright">
                    ...
                    <ul>
                        <li><a href="{{ route('auth.profile') }}"><i class="os-icon os-icon-user-male-circle2"></i><span>Profile Details Test</span></a></li>
